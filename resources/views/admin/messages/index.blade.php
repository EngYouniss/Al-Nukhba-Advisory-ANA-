        ...
        <div class="fi-card-header card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="input-group input-group-sm fi-search" style="max-width: 200px;">
                    <form action="{{ route('messages.index') }}" method="GET" class="d-flex w-100">
                    ...
                    <tbody>
                        @forelse ($messages as $message)
                            <tr>
                                ...
                                {{-- <td><span
                                        class="badge badge-{{ $message->status === 1 ? 'info' : 'success' }} badge-pill">{{ $message->status === 1 ? 'مفعل' : 'غير مفعل' }}</span>
                                </td> --}}
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        :delete-route="route('messages.destroy', $message->id)"
                                        :show-route="route('messages.show',$message->id)"/>
