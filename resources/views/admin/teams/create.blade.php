                ...
                <form action="{{ route('teams.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label>الاسم</label>
                            <input type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="مثال: أحمد محمد">
                            <x-validation-error field="name" />
                        </div>

                        <div class="form-group col-md-6">
                            <label>التخصص / الوظيفة</label>
                            <input type="text" class="form-control" name="position" value="{{ old('position') }}" placeholder="مثال: مدير تسويق">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control mb-2" name="social_media[facebook]" value="{{ old('social_media.facebook') }}" placeholder="رابط فيسبوك">
                        <input type="text" class="form-control mb-2" name="social_media[twitter]" value="{{ old('social_media.twitter') }}" placeholder="رابط تويتر">
                        <input type="text" class="form-control mb-2" name="social_media[linkedin]" value="{{ old('social_media.linkedin') }}" placeholder="رابط لينكدإن">
                    </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <img id="image_preview" src="#" alt="" class="img-thumbnail d-none mt-2" style="max-height:160px;">
                    </div>
